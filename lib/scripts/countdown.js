...
var classMessage = $('.class-message');
...
function displayClassMessage() {
  if (timer.currentClass === 'work timer') {$(classMessage).text('You should be working.')};
  if (timer.currentClass === 'break timer') {$(classMessage).text('You should NOT be working.')}
}
