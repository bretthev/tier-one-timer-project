...
function hideInputs() {
    $(userGeneratedWorkTimeLength).attr('hidden', true);
    $(userGeneratedBreakTimeLength).attr('hidden', true);
}
...
function hideAllButtons() {
  ...
  $(changeWorkTimeLengthButton).attr('hidden', true);
  $(changeBreakTimeLengthButton).attr('hidden', true);
}

function showButtons() {
  $(resetTimerButton).attr('hidden', false);
  $(resumeTimerButton).attr('hidden', false);
  $(changeWorkTimeLengthButton).attr('hidden', false);
  $(changeBreakTimeLengthButton).attr('hidden', false);
}
...
$(changeWorkTimeLengthButton).on('click', function() {
  userGeneratedWorkTimeLength.attr('hidden', false);
  userGeneratedBreakTimeLength.attr('hidden', true);
...
$(changeBreakTimeLengthButton).on('click', function() {
  userGeneratedWorkTimeLength.attr('hidden', true)
  userGeneratedBreakTimeLength.attr('hidden', false);
  $(pomodoroContainer).addClass('blur-background');
  $('.button-container').attr('hidden', true);
  hideAllButtons();
});
